#! /usr/bin/env perl
#
# Install script for JsonSQLPlugin
#
...
Foswiki::Extender::install( $PACKAGES_URL, 'JsonSQLPlugin', 'JsonSQLPlugin',
    @DATA );
...
__DATA__
<<<< MANIFEST >>>>
data/System/JsonSQLPlugin.txt,0664,7eb0985e7096707a0377ede7dd8d8e3f,
lib/Foswiki/Plugins/JsonSQLPlugin.pm,0664,55b9b7cfc776275e031ef71a5c3dee8a,
lib/Foswiki/Plugins/JsonSQLPlugin/Config.spec,0664,308229d0295c324cfd1e6007ef89d39e,
lib/Foswiki/Plugins/JsonSQLPlugin/DEPENDENCIES,0664,0a2b07528ba0f7542993147d195e4bca,

<<<< DEPENDENCIES >>>>
Foswiki::Func,>=0,1,cpan,May be required for lib/Foswiki/Plugins/JsonSQLPlugin.pm
Foswiki::Plugins,>=0,1,cpan,May be required for lib/Foswiki/Plugins/JsonSQLPlugin.pm
JsonSQL,>=0,1,cpan,May be required for lib/Foswiki/Plugins/JsonSQLPlugin.pm
DBI,>=0,1,cpan,May be required for lib/Foswiki/Plugins/JsonSQLPlugin.pm
JSON,>=0,1,cpan,May be required for lib/Foswiki/Plugins/JsonSQLPlugin.pm
